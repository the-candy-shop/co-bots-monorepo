...
interface VRFCoordinatorV2TestHelperInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calculatePaymentAmountTest(uint256,uint32,uint256)": FunctionFragment;
    ...
    "getGasStart()": FunctionFragment;
    "getPaymentAmount()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculatePaymentAmountTest",
  ...
  encodeFunctionData(
    functionFragment: "getGasStart",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getPaymentAmount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class VRFCoordinatorV2TestHelper extends BaseContract {
  ...
  interface: VRFCoordinatorV2TestHelperInterface;
  ...
  functions: {
    ...
    calculatePaymentAmountTest(
      ...
      fulfillmentFlatFeeLinkPPM: BigNumberish,
    ...
    getGasStart(overrides?: CallOverrides): Promise<[BigNumber]>;

    getPaymentAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getGasStart(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getPaymentAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
